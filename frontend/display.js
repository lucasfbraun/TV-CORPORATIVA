...
(function keepAwake() {
  ...
  // Camada 2: vídeo keepalive (2s, mudo, fora da tela).
  // Embutido como data URI: não depende de rota do servidor, rede nem cache —
  // funciona mesmo se o backend estiver desatualizado ou o arquivo sumir.
  const KEEPAWAKE_MP4 = 'data:video/mp4;base64,';
  ...
  ['pause', 'stalled', 'suspend', 'ended'].forEach(ev => v.addEventListener(ev, play));
